...
import { EmailCorporateVO } from "../../../core/domain/value-objects/email-corporate-vo";
import { PasswordVO } from "./value-objects/password-vo";
import { RolesVO } from "./value-objects/roles-vo";
import { validate, v4 } from "uuid"
import { UuidVO } from "../../../core/domain/value-objects/uuid-vo";
...
const user = UserFactory.create(v4(), "John", "Doe", "john.doe@company.org", "ElMundoEsMio123#", ["admin"]);
console.log(user);
