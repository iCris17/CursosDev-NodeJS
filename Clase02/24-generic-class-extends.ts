...
class Medic extends BaseEntity {
    constructor(public id: string, public name: string, public lastname: string) {super()}
}

class User extends BaseEntity{
    constructor(public id: number, public username: string, public password: string){super()}
}
